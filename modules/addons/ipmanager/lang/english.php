...
$_ADDONLANG["assign_pool_products_servers"]      = "Assign pool to products and servers";
$_ADDONLANG["assign_pool_products_servers_help"] = "Select a Pool or Subnet, then check one or more Products and/or Servers (clusters/nodes). Save to apply. These will receive an IP from the chosen pool when provisioned.";
$_ADDONLANG["pool_or_subnet_required"] = "Select at least one Pool or Subnet.";
$_ADDONLANG["products"]                = "Products";
$_ADDONLANG["servers_nodes"]           = "Servers (clusters / nodes)";
$_ADDONLANG["no_products"]             = "No products.";
$_ADDONLANG["no_servers"]              = "No servers. Add servers in Setup → Products/Services → Servers.";
$_ADDONLANG["save_products_servers"]   = "Save products and servers selection";
$_ADDONLANG["bulk_saved"]              = "Products and servers selection saved.";
